							...
							<div class="col-lg-12">
								<section class="panel">
									...
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="../controller/itemcontroller.php?action=add" enctype="multipart/form-data" name="RegForm" method="POST">
                                        <div class="form-group">
												<label class="col-md-3 control-label" for="inputPopover">Item Name</label>
												<div class="col-md-6">
													<input required type="text" id="item_name" name="item_name" placeholder="Click Here" class="form-control" data-toggle="popover" data-placement="top" data-original-title="The Title" data-content="Content goes here..." data-trigger="click">
												</div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<input required type="text" id="item_price" name="item_price" placeholder="Click Here" class="form-control" data-toggle="popover" data-placement="top" data-original-title="The Title" data-content="Content goes here..." data-trigger="click" id="inputPopover">
												</div>
                                            </div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<textarea required class="form-control" rows="3" id="textareaAutosize" data-plugin-textarea-autosize id="item_des" name="item_des"></textarea>
												</div>
                                            </div>
                                            
                                        <button type="submit" class="mb-xs mt-xs mr-xs btn btn-primary btn-lg btn-block">Add Item</button>
										</form>
									</div>
								</section>
